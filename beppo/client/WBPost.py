...
from beppo.Constants import IN_QUEUE, IN_CLASS, IN_VIEW, OUT, IN_POST_PROCESS

class PostAdmin:
    def __init__(self, avatar):
        self.avatar = avatar
        self.dialog = PostDialog(self)
        self.questions = {}
        self.getQuestions()
...
class PostDialog(Toplevel):
    ...
    def refresh(self, event=None):
        ...
        for idQ, question in self.admin.questions.iteritems():
            ...
            self.listbox.insert(END, "%s" % question)
